...
__ieee754_lgamma_r(double x, int *signgamp)
{
	...
	*signgamp = 1;
    ...
    /* for x < 2.0 */
	    ...
	    switch(i) {
	    case 7: z *= (y+6.0);	__attribute_fallthrough__;
	    case 6: z *= (y+5.0);	__attribute_fallthrough__;
	    case 5: z *= (y+4.0);	__attribute_fallthrough__;
	    case 4: z *= (y+3.0);	__attribute_fallthrough__;
	    case 3: z *= (y+2.0);
